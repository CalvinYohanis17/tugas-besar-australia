...
const destinasiData = {
    "sydney-opera": {
        ...
        deskripsi: "Ikon arsitektur modern abad ke-20 yang terkenal dengan atap cangkang putih berbentuk layar kapal.",
        deskripsiDetail: "Sydney Opera House merupakan salah satu mahakarya arsitektur abad ke-20 yang paling terkenal di dunia. Didesain oleh arsitek asal Denmark, Jørn Utzon, gedung pertunjukan ini diresmikan pada tahun 1973 setelah melewati proses pembangunan yang kompleks. Terletak di Bennelong Point di Pelabuhan Sydney, gedung ini memiliki atap berbentuk cangkang putih (shell) unik yang menyerupai bentangan layar kapal laut besar.\n\nSelain menjadi pusat seni pertunjukan kelas dunia dengan ribuan konser, teater, dan pertunjukan opera setiap tahunnya, tempat ini juga telah diakui sebagai Situs Warisan Dunia UNESCO sejak tahun 2007. Keindahannya terpancar maksimal saat senja hari, memancarkan pantulan cahaya matahari yang berkilau di atas permukaan pelabuhan.",
        lokasi: "Bennelong Point, Sydney NSW 2000",
        waktuTerbaik: "Sep — Nov (Musim Semi) & Mar — Mei (Musim Gugur)",
        aktivitas: "Tur sejarah arsitektur bagian dalam, menonton konser opera, bersantai di Opera Bar pinggir pelabuhan."
    },
    "great-barrier-reef": {
        nama: "Great Barrier Reef",
        tag: "QUEENSLAND",
        img: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=80",
        deskripsi: "Sistem terumbu karang terbesar di dunia dengan keanekaragaman hayati bawah laut yang menakjubkan.",
        deskripsiDetail: "Great Barrier Reef adalah struktur hidup terbesar di bumi yang membentang sepanjang lebih dari 2.300 kilometer di lepas pantai Queensland. Kumpulan terumbu karang ini sangat luas sehingga dapat terlihat dengan jelas dari luar angkasa. Area ini menjadi rumah bagi ribuan spesies kehidupan laut, termasuk 600 jenis karang keras dan lunak, lebih dari 1.500 spesies ikan tropis, lumba-lumba, penyu, hingga paus.\n\nDestinasi ini adalah surga mutlak bagi para penyelam dan pecinta alam. Wisatawan dapat menjelajahi ekosistem laut ini melalui scuba diving, snorkeling, kapal selam kaca, atau menikmati keindahan pulau pasir putih karang eksklusif dari udara dengan helikopter wisata.",
        lokasi: "Laut Koral, Lepas Pantai Queensland",
        waktuTerbaik: "Juni — Oktober (Musim Kering & Suhu Nyaman)",
        aktivitas: "Snorkeling, scuba diving, tur helikopter melihat 'Heart Reef', menginap di resort pulau terpencil."
    },
    "uluru": {
        ...
        waktuTerbaik: "Mei — September (Suhu udara gurun lebih dingin)",
        aktivitas: "Berjalan menyusuri rute pangkalan Uluru, menikmati makan malam di bawah bintang gurun, mempelajari budaya Anangu."
    },
    "melbourne-laneways": {
        ...
        waktuTerbaik: "Maret — Mei (Musim Gugur dengan dedaunan emas)",
        aktivitas: "Berburu foto seni dinding jalanan, mencicipi kopi spesial di gang-gang bersejarah, tur kuliner tersembunyi."
    },
    "great-ocean-road": {
        ...
        waktuTerbaik: "Desember — Februari (Musim Panas untuk aktivitas pantai)",
        aktivitas: "Road trip santai, melihat Twelve Apostles dari gardu pandang, berjalan di kanopi hutan hujan Otway Fly."
    },
    "kakadu": {
        ...
        waktuTerbaik: "Mei — September (Musim Kering, akses jalan terbuka penuh)",
        aktivitas: "Melihat buaya air asin di perairan Billabong, trekking ke kolam air terjun alami, tur melihat lukisan gua purba."
    }
};
...
const floraFaunaData = {
    "kangaroo": {
        ...
        status: "Least Concern (Risiko Rendah / Populasi Melimpah)",
        faktaMenarik: "Kanguru tidak bisa berjalan mundur karena struktur kaki belakangnya yang sangat khusus."
    },
    "koala": {
        nama: "Koala",
        tag: "FAUNA HERBIVOR",
        ...
        status: "Vulnerable (Rentan terhadap kepunahan akibat hilangnya habitat)",
        faktaMenarik: "Koala memiliki sidik jari yang sangat mirip dengan sidik jari manusia, bahkan di bawah mikroskop elektron sulit dibedakan."
    },
    "wombat": {
        nama: "Wombat",
        tag: "FAUNA ENDEMIK",
        ...
        status: "Least Concern (Stabil, spesies wombat utara berstatus Kritis)",
        faktaMenarik: "Kotoran wombat berbentuk kubus sempurna. Hal ini membantu kotoran tidak menggelinding dari batu atau batang kayu yang mereka gunakan untuk menandai wilayah kekuasaan mereka."
    },
    "eucalyptus": {
        ...
        status: "Melimpah / Aman",
        faktaMenarik: "Banyak spesies eukaliptus beradaptasi secara khusus terhadap kebakaran hutan; mereka membutuhkan suhu panas api untuk membuka benih biji keras mereka agar bisa beregenerasi."
    },
    "waratah": {
        nama: "Waratah Flower",
        ...
        status: "Dilindungi secara ketat dari pemetikan liar",
        faktaMenarik: "Nama 'Waratah' berasal dari bahasa suku Aborigin Eora yang berarti 'merah dari kejauhan' atau 'terlihat dari jauh'."
    },
    "golden-wattle": {
        nama: "Golden Wattle",
        tag: "FLORA NASIONAL",
        ...
        status: "Least Concern (Risiko Rendah / Sangat Umum)",
        faktaMenarik: "Hari Wattle Nasional diperingati setiap tanggal 1 September di Australia untuk merayakan awal musim semi yang dihiasi mekarnya bunga emas ini."
    }
};
